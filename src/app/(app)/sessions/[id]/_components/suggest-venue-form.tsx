...
export function SuggestVenueForm({
  ...
  return (
    ...
    >
      <div
        className="w-full rounded-t-2xl bg-[#FFF8F0] px-5 pb-8 pt-5 shadow-xl flex flex-col gap-4 max-h-[90dvh] overflow-y-auto"
      ...
      >
        ...
        <button
          ...
          className="flex w-full items-center justify-center rounded-xl bg-coral py-3.5 text-sm font-semibold text-white transition-opacity active:opacity-70 disabled:opacity-40"
        >
          {submitting ? "Lagi kirim..." : "Suggest Sekarang 🚀"}
        </button>
      </div>
    </div>
  );
