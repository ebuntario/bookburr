...
export function HostDiscoveringCTA({
  ...
  if (discoveryFailed) {
    return (
      <div className="rounded-2xl border border-danger/30 bg-danger/5 px-5 py-5 flex flex-col gap-3">
        <div className="flex gap-2 items-start">
          <ExclamationTriangleIcon className="h-5 w-5 shrink-0 text-danger mt-0.5" />
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl border border-danger/30 py-2.5 text-sm font-medium text-danger"
        >
